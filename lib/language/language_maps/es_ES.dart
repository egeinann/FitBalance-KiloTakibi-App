...
const Map<String, String> esES = {
  ...
  "This section cannot be left blank": "Esta sección no puede quedar vacía",
  // IntroStartScreen
  "Welcome": "¡Bienvenido!",
  ...
  // IntroGraphScreen
  "Graphs": "Gráficos",
  "Track your progress with graphs!": "¡Sigue tu progreso con gráficos!",

  // IntroPhotoGalleryScreen
  "Photo & Gallery": "Foto y Galería",
  "Document your changes with photos!": "¡Documenta tus cambios con fotos!",
...
// RiveController
  ...
  "6. Changes to the Privacy Policy": "6. Cambios en la Política de Privacidad",
  ...
  'Your target weight has been updated': 'Tu peso objetivo ha sido actualizado',
