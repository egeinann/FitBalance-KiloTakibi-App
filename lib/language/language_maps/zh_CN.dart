...
const Map<String, String> zhCN = {
  ...
  // IntroStartScreen
  "Welcome": "欢迎",
  "Easily record your weight and achieve your goals!": "轻松记录您的体重并实现您的目标！",
  ...
  "You look quite overweight, you should lose weight.": "你看起来非常超重，应该减肥。",
  'BMI: ': "BMI: ",
  ...
  'You need to grant permission to enable notifications.': '您需要授权才能启用通知。',
  'OK': '好的',
  'kg': '千克',
  'lbs': '磅',
  'cm': '厘米',
  ...
  'If you have any questions regarding these Terms of Service, please contact us at:\n'
      '- Email: fitbalance.app@gmail.com': '如果您对这些服务条款有任何疑问，请通过以下方式与我们联系：\n'
      '- 电子邮件：fitbalance.app@gmail.com',
  'By using the application, you agree to these terms.': '使用该应用程序即表示您同意这些条款。',
  ...
  "Reach your goal with ad-free, uninterrupted tracking!": "通过无广告、不间断的跟踪达成目标！",
